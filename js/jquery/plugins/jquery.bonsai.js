...
(function($){
  ...
  Bonsai.prototype = {
    ...
    insertCheckbox: function(listItem) {
      ...
      children.remove();
      //listItem.append($('<label for="' + id + '">').append(checkbox).append(text ? children : children.slice(1)));
      listItem.append(checkbox).append($('<label for="' + id + '">').append(text ? text : children.first())).append(text ? children : children.slice(1));
    },
